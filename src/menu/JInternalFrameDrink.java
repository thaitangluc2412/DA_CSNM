...
public class JInternalFrameDrink extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JInternalFrameDrink frame = new JInternalFrameDrink();
	...
	private void loadData() {
		List<FoodDrink> lists = Utils.getListDrink();
